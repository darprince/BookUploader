...
public class Book {
	...
	public boolean updateTable(Connection connect) {
		try {
			final String sql = "UPDATE princewalker.books set author =?, authorID =?, title =?, "
					+ "rating =?, synopsis =?, " + "pages =?, " + "seriesID =?, " + "seriesNumber =?, " + "year =?, "
					+ "genre =?, " + "image =?, " + "googleId =?, " + "goodreadsId =?, "
	...
	public String toString() {
		return "Book [isbn=" + isbn + ", filename=" + filename + ", author=" + author + ", authorId=" + authorId
				+ ", title=" + title + ", rating=" + rating + ", synopsis=" + synopsis + ", pages=" + pages
				+ ", seriesId=" + seriesId + ", seriesNumber=" + seriesNumber + ", year=" + year + ", genre=" + genre
